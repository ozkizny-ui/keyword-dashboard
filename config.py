...
# st.secrets를 딕셔너리로 한 번에 로드 (CLI 환경에서는 빈 dict)
try:
...
# ──────────────────────────────────────────────
NAVER_AD_API_LICENSE = _env("NAVER_AD_API_LICENSE")
NAVER_AD_SECRET_KEY  = _env("NAVER_AD_SECRET_KEY")
NAVER_AD_CUSTOMER_ID = _env("NAVER_AD_CUSTOMER_ID")
...
GOOGLE_CREDENTIALS_JSON = _env("GOOGLE_CREDENTIALS_JSON", "")  # JSON 문자열 (Streamlit Cloud)
